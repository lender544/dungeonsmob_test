package com.infamous.dungeonstest.client.Model;// Made with Blockbench 3.6.6
...
public class TornadoProjectileModel extends AnimatedGeoModel {
	   
	@Override
	public ResourceLocation getAnimationFileLocation(Object entity) {
		return new ResourceLocation(DungeonsTest.MODID, "animations/tornado_projectile.animation.json");
	}

	@Override
	public ResourceLocation getModelLocation(Object entity) {
		return new ResourceLocation(DungeonsTest.MODID, "geo/tornado_projectile.geo.json");
	}

	@Override
	public ResourceLocation getTextureLocation(Object entity) {
		//ChorusGormandizerEntity entityIn = (ChorusGormandizerEntity) entity;
		return new ResourceLocation(DungeonsTest.MODID, "textures/entity/cloud.png");
	}
	...
	public void setLivingAnimations(IAnimatable entity, Integer uniqueID, AnimationEvent customPredicate) {
		...
		TornadoProjetileEntity entityIn = (TornadoProjetileEntity) entity;
