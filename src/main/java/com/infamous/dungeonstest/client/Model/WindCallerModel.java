...
public class WindCallerModel extends AnimatedGeoModel {
		...
		public ResourceLocation getAnimationFileLocation(Object entity) {
			return new ResourceLocation(DungeonsTest.MODID, "animations/windcaller.animation.json");
		}

		@Override
		public ResourceLocation getModelLocation(Object entity) {
			return new ResourceLocation(DungeonsTest.MODID, "geo/windcaller.geo.json");
		}

		@Override
		public ResourceLocation getTextureLocation(Object entity) {
			//ChorusGormandizerEntity entityIn = (ChorusGormandizerEntity) entity;
			return new ResourceLocation(DungeonsTest.MODID, "textures/entity/windcaller.png");
		}
